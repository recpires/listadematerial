// Dados extraídos do PDF "Lista de Material 2026"
const materialData = {
    // --- EDUCAÇÃO INFANTIL ---
    maternal: {
        ...
        books: [
            { name: "Coleção SIE - Ed. Infantil 3 anos - 1º Semestre", price: "R$ 192,00" },
            { name: "Coleção SIE - Ed. Infantil 3 anos - 2º Semestre", price: "R$ 192,00" },
            ...
            { name: "Todos os Sentimentos são importantes + Cards", price: "R$ 59,00" },
    ...
    // Adicionei exemplos de outras turmas baseados no padrão. O código pode ser estendido.
    "6ano": {
     ...
     "1em": {
        ...
        books: [
            ...
            { name: "Paradidático: Universo Paralelo", price: "R$ 35,00" },
            { name: "Paradidático: Bastidores da Mídia", price: "R$ 37,00" }
        ],
        stationery: [
            "1 Régua 20cm",
            "3 Lápis pretos",
...
function renderContent(gradeKey) {
    ...
    if (!data) {
        contentDiv.innerHTML = `<div style="text-align:center; padding:3rem; color:#888;">
            ...
            <p>Lista desta turma ainda está sendo digitalizada.<br>Consulte o PDF original.</p>
        </div>`;
        return;
    }
    ...
    let stationeryHtml = data.stationery.map(item => `
    ...
    contentDiv.innerHTML = `
        <div class="grade-header">
            ...
            <span class="grade-total">Total Livros/Apostilas: ${data.totalBooks}</span>
        </div>
        ...
        <h3><i class="fa-solid fa-pencil"></i> Material de Papelaria (Checklist)</h3>
...
document.addEventListener('DOMContentLoaded', () => {
    AOS.init();
    renderContent('maternal'); // Carrega Maternal por padrão
});